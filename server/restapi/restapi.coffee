...
Api.addRoute 'updateCollections', authRequired: false,
	get: ->
		messages = RocketChat.models.Messages.find().fetch()
		for message in messages
			...
			timeLine = RocketChat.services.getMessageTimeLine(message, previous)
			RocketChat.models.Messages.update({_id: message._id}, {$set: {timeLine: timeLine}})
		status: 'success'

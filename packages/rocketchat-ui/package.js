...
Package.onUse(function(api) {
	...
	api.addFiles('views/app/roomNotifications.html', 'client');
	api.addFiles('views/app/createGroup.html', 'client');
	api.addFiles('views/app/addUserToRoom.html', 'client');
	...
	api.addFiles('views/app/roomNotifications.coffee', 'client');
	api.addFiles('views/app/createGroup.coffee', 'client');
	api.addFiles('views/app/addUserToRoom.coffee', 'client');

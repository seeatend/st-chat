...
Package.onUse(function(api) {
	...
	api.addFiles('lib/organizations.coffee');

	api.addFiles('lib/Message.coffee');
	api.addFiles('lib/MessageTypes.coffee');
	// LIB SERVICES
	api.addFiles('lib/services/common.coffee');
	api.addFiles('lib/services/messages.coffee');
	...
	api.addFiles('server/models/Organizations.coffee', 'server');
	api.addFiles('server/models/Mentions.coffee', 'server');

	// SERVER PUBLICATIONS
	api.addFiles('server/publications/settings.coffee', 'server');
	api.addFiles('server/publications/organization.coffee', 'server');
	...
	// XXX api.addFiles('server/methods/checkRegistrationSecretURL.coffee', 'server');

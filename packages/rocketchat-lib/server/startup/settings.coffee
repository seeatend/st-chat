...
RocketChat.settings.addGroup 'FileUpload', ->
	...
	@add 'FileUpload_MaxFileSize', 20971520, { type: 'int', public: true }
	@add 'FileUpload_MaxFileSize_ForPremuim', 209715200, { type: 'int', public: true }
	@add 'FileUpload_MediaTypeWhiteList', 'image/*,audio/*,video/*,application/pdf,application/x-rar-compressed,application/zip,text/plain,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document', { type: 'string', public: true, i18nDescription: 'FileUpload_MediaTypeWhiteListDescription' }
...
RocketChat.settings.addGroup 'API', ->
	...
	@add 'API_Segment_KEY', '', { type: 'string', public: true}

RocketChat.settings.addGroup 'Stripe', ->
	@add 'Payment_Enabled', false, { type: 'boolean', group: 'Stripe', public: true }
	@add 'Stripe_PublishableKey', '', { type: 'string', group: 'Stripe', public: true }
	@add 'Stripe_SecretKey', '', { type: 'string', group: 'Stripe' }
...
RocketChat.settings.addGroup 'SMTP', ->
	...
	@add 'From_Email', 'no-reply@teamstitch.com', { type: 'string', placeholder: 'email@domain' }
...
RocketChat.settings.addGroup 'Layout', ->
	...
	@section 'Login', ->
		@add 'Layout_Login_Header', '<a class="logo" href="/"><p>STITCH</p></a>', { type: 'string', multiline: true, public: true }
...
Meteor.startup ->
	...
	if RocketChat.settings.get('Payment_Enabled')
		process.env.STRIPE_PUBLISH_KEY = RocketChat.settings.get('Stripe_PublishableKey')
		process.env.STRIPE_PRIVATE_KEY = RocketChat.settings.get('Stripe_SecretKey')

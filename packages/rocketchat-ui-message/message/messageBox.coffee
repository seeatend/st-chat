isSubscribed = (_id) ->
	return ChatSubscription.find({ 'u._id': Meteor.userId(), rid: _id }).count() > 0
...
Template.messageBox.helpers
	...
	isCordova: ->
		return Meteor.isCordova or navigator.userAgent.match(/(iPad|iPhone|iPod)/g) or navigator.userAgent.toLowerCase().indexOf('android') > -1
